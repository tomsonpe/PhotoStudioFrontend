 ...
 */
public class OthersRepositoryImplem extends SQLiteOpenHelper implements OthersRepository {
    ...
    public OthersRepositoryImplem(Context context){
   ...
   //     this.close();
    ...
    public Others findByid(Long id) {
        ...
        if(cursor.moveToNext()){
            final Address address = new Address.Builder()
                    ...
                    .build();
            final Others others = new Others.Builder()
    ...
    @Override
    public Others save(Others entity) throws SQLException {
        ...
        Others insertOthers = new Others.Builder()
                .copy(entity)
                .id(new Long(id))
                .build();
        return insertOthers;
    ...
    @Override
    public Others  update(Others entity) throws SQLException{
        open();
        ContentValues values = new ContentValues();
        values.put(COLUMN_ID, entity.getId());
        values.put(COLUMN_FIRSTNAME, entity.getName());
    ...
    @Override
    public Others delete(Others entity) throws SQLException{
        open();
        db.delete(
                TABLE_NAME,
                COLUMN_ID + " =? ",
    ...
    @Override
    public Set<Others> findAll() throws SQLException{
        SQLiteDatabase db = this.getReadableDatabase();
        Set<Others > other = new HashSet<>();
        open();
