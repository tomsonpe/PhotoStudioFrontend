 ...
 */
public class FuneralRepositoryImplem extends SQLiteOpenHelper implements FuneralReapository {
...
//        this.close();
    ...
    public Funeral findByid(Long id) {
        ...
        if(cursor.moveToNext()){
            final Address address = new Address.Builder()
                    ...
                    .build();
            final Funeral funeral = new Funeral.Builder()
    ...
    @Override
    public Funeral save(Funeral entity) throws SQLException {
        ...
        Funeral insertFuneral = new Funeral.Builder()
                .copy(entity)
                .id(new Long(id))
                .build();
    ...
    @Override
    public Funeral update(Funeral entity) throws SQLException{
        open();
        ContentValues values = new ContentValues();
        values.put(COLUMN_ID, entity.getId());
        values.put(COLUMN_FIRSTNAME, entity.getName());
    ...
    @Override
    public Funeral delete(Funeral entity) throws SQLException{
        open();
        db.delete(
                TABLE_NAME,
                COLUMN_ID + " =? ",
    ...
    @Override
    public Set<Funeral> findAll() throws SQLException{
        SQLiteDatabase db = this.getReadableDatabase();
        Set<Funeral > fun = new HashSet<>();
        open();
