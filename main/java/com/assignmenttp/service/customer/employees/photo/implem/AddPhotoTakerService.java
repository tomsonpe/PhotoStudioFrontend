 ...
 */
public class AddPhotoTakerService extends IntentService implements PhotoService{
    private final PhotoRepository repository;
    private static  AddPhotoTakerService service = null;
    ...
    public AddPhotoTakerService() {
        super("AddPhotoTakerService");
        repository = new PhotoReapositoryImpem(App.getContext());
    }

    private static AddPhotoTakerService getInstance(){
        if(service == null)
            service = new AddPhotoTakerService();
        return service;
    }

    @Override
    public void addPhotoTakers(Context context,Photo photo){
