 ...
 */
public class AddOthersServiceimplem extends IntentService implements AddOthersService {
    private final OthersRepository repository;
    private static  AddOthersServiceimplem service = null;
    ...
    public AddOthersServiceimplem() {
        super("AddOthersServiceimplem");
        repository = new OthersRepositoryImplem(App.getContext());
    }

    private static AddOthersServiceimplem getInstance(){
        if(service == null)
            service = new AddOthersServiceimplem();
        return service;
    }

    @Override
    public void addOthers(Context context,Others others){
        Intent intent = new Intent(context,AddOthersServiceimplem.class);
