 ...
 */
public class UpdateBirthdayPartyServiceImplem extends IntentService implements UpdateBirthdayPartyService {
    ...
    public UpdateBirthdayPartyServiceImplem() {
        super("UpdateBirthdayPartyServiceImplem");
    ...
    @Override
    public void updateParty(Context context,BirthdayParty cash){
