...
import com.assignmenttp.service.customer.employees.video.implem.AddVideoTAkerService;
 ...
 */
public class AddVideoServiceTest extends AndroidTestCase {
    ...
    public void testAddVideoTaker() throws Exception{
        Long id;
        Intent intent = new Intent(App.getContext(), AddVideoTAkerService.class);
        VideoService video = new AddVideoTAkerService();
        ...
        video.addVideoTakers(App.getContext(), videos);
